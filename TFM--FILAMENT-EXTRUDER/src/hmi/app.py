...
from backend.CAMERA_HQ import CAMERA_HQ
        ...
        children=[
            html.Div(
                ...
                children=[
                    ...
                    html.Img(id='video-feed', className='grafico-img'),
                ]
            ),
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Div([html.Label("Calefactor"), html.Div(className='led-off')], className='estado'),
            html.Div([html.Label("Motor Extrusora"), html.Div(className='led-off')], className='estado'),
            html.Div([html.Label("Motor Enrolladora"), html.Div(className='led-off')], className='estado'),
            html.Div([html.Label("Láser"), html.Div(className='led-off')], className='estado'),
            html.Div([html.Label("Cámara"), html.Div(className='led-off')], className='estado'),
        ], className='estados'),
...
@app.callback(
    ...
    Input('intervalo-rapido', 'n_intervals'),
    prevent_initial_call=True
)
def actualizar_video(n):
    return cam.get_frame_base64()
